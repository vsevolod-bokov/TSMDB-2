...
function SmsMultiFactorAssertionPhoneForm(props) {
  const ui = useUI();
      ...
      <FormItem>
        ...
        <FormDescription>
          {getTranslation(ui, "messages", "mfaSmsAssertionPrompt", {
            phoneNumber: (props.hint).phoneNumber || "",
          })}
        </FormDescription>
      </FormItem>
...
function SmsMultiFactorAssertionVerifyForm(props) {
  const ui = useUI();
...
export function SmsMultiFactorAssertionForm(props) {
