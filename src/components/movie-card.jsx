        ...
        <CardContent className="p-0">
          <div className="relative">
            ...
            {movie.vote_average > 0 && (
              <div className="absolute bottom-0 left-0 right-0 bg-black/70 backdrop-blur-sm px-2 py-1 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
